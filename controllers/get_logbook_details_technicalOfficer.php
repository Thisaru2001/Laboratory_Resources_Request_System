<?php
/**
 * Fetch full logbook details for technical officer review modal
 */
session_start();
...
if (!$result) {
    error_log('Database error in get_logbook_details_technicalOfficer.php: ' . Database::getLastError());
